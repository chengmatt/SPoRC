...
#' (\code{do_FishAge_corr_pars_mapping}, \code{do_FishAge_pop_corr_pars_mapping},
#' \code{do_FishLen_corr_pars_mapping}, \code{do_FishLen_pop_corr_pars_mapping},
#' and their \code{_discard} counterparts) into one, parameterized the same way
#' as \code{\link{do_comp_theta_mapping}}.
#'
#' @param input_list Named list with \code{$data}, \code{$par}, and \code{$map}
#'   sublists.
#' @param comp_prefix Character, either \code{"FishAge"} or \code{"FishLen"}.
...
#' to \code{NA}. Consolidates what were previously two near-identical
#' functions, \code{do_fish_q_mapping} and \code{do_srv_q_mapping}.
#'
#' @param input_list Named list with \code{$data}, \code{$par}, and \code{$map}
#'   sublists.
...
#' \code{do_fish_fixed_sel_pars_mapping}, \code{do_ret_fixed_sel_pars_mapping},
#' and \code{do_srv_fixed_sel_pars_mapping}.
#'
#' @param input_list Named list with \code{$data}, \code{$par}, and \code{$map}
#'   sublists.
...
#'
#' Consolidates what were previously three near-identical functions,
#' \code{do_fishsel_pe_pars_mapping}, \code{do_retsel_pe_pars_mapping}, and
#' \code{do_srvsel_pe_pars_mapping}.
#'
#' @param input_list Named list with \code{$data}, \code{$par}, and \code{$map}
#'   sublists.
...
#'
#' Consolidates what were previously three near-identical functions,
#' \code{do_fishsel_devs_mapping}, \code{do_retsel_devs_mapping}, and
#' \code{do_srvsel_devs_mapping}.
#'
#' @param input_list Named list with \code{$data}, \code{$par}, and \code{$map}
#'   sublists.
