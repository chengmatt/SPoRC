...
#'   \code{SR_pen_nLL}, \code{sel_nLL}, \code{conv_fish_tag_nLL},
  ...
  for(i in 1:length(rep)) {
    ...
    nLL_df <- data.frame(
      ...
      value = c(safe_extract(rep[[i]], "jnLL"),
                ...
                sum(safe_extract(rep[[i]], "Init_Sex_nLL")),
                sum(safe_extract(rep[[i]], "Rec_level_nLL")),
                sum(safe_extract(rep[[i]], "SR_pen_nLL")),
      ...
      type = c('jnLL', 'Prior', "Prior", "Prior", "Prior", "Penalty", "Penalty", "Tagging",
               ...
               "Prior", "Index", "Penalty", "Penalty", "Penalty", "Penalty", "Prior", "Age",
               "Age", "Length", "Length",
               "Catch", "Index", "Index",
