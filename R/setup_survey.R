...
#
# Survey inputs: indices, compositions, selectivity and catchability, for both
# the estimation model and the operating model. Mirrors the fishery side but has
# no retention or discard stream.
