...
| srv_sel_model | Array dimensioned by n_regions, n_years, n_srv_fleets specifying the selectivity functional form. Same options as fish_sel_model, including bicubic (8). Further details in Get_Selex.R |
