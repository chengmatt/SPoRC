...
input_list <- Setup_Mod_SrvIdx_and_Comps(
  ...
  # and the extra component is carried as a parameter instead. Fleets 1 and 4 sit
  # at the assessment's lower bound, which is it asking for none, so they are held.
  ObsSrvIdx_SE = sweep_extra_sd(dat),
