...
| Script | Defines | Calls into | Called from |
|----|----|----|----|
| `diag_fits.R` | `get_caal_fits`, `get_caal_prop`, `get_comp_prop`, `get_idx_fits`, `Restrc_Comps` | nothing | `diag_francis.R`, `plot_figures_tables.R` |
