...
historical `SPoRC` behaviour), mortality then movement (`1`), or the two
...
dimension shared across fleets. The length analogue $`\mathbf{\Lambda}`$
...
and it is the correlation that lets neighbouring ages and years share
