...
Beverton-Holt equations above still apply, but with
...
additional survival discounting: fishing is spread across the whole
season rather than occurring at a point within it, so there is no
analogue of $`t^{srv}`$ to discount by.
