...
- [Description of Model and Data
  Dimensions](https://chengmatt.github.io/SPoRC/dev/articles/a_model_dimensions.md):
- [Description of Model
  Parameters](https://chengmatt.github.io/SPoRC/dev/articles/b_model_parameters.md):
- [Description of Model
...
- [Deriving Reference Points, Catch Advice, and
  Projections](https://chengmatt.github.io/SPoRC/dev/articles/i_reference_points.md):
- [Simulation Testing (Cross and Self
  Tests)](https://chengmatt.github.io/SPoRC/dev/articles/l_simulation_testing.md):
- [Description of Simulation
  Dimensions](https://chengmatt.github.io/SPoRC/dev/articles/m_simulation_dimensions.md):

### Advanced: Setup

- [Starting Values and Fixing (and Sharing)
  Parameters](https://chengmatt.github.io/SPoRC/dev/articles/j_starting_mapping.md):
- [Defining
...
- [Dynamic Structural Equation
  Models](https://chengmatt.github.io/SPoRC/dev/articles/ag_dsem.md):
...
- [Testing Management Procedures via Closed Loop Simulations (Dusky
  Rockfish)](https://chengmatt.github.io/SPoRC/dev/articles/p_single_region_dusky_alt_mp_testing.md):
- [Specifying a Natal Homing
