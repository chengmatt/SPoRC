# Purpose: Bridge the 2024 GOA northern rockfish assessment to SPoRC and render its figures
...
ggplot2::ggsave(
  here("vignettes", "figures", "w_goa_nork_ts_comparison.png"),
...
ggplot2::ggsave(
  here("vignettes", "figures", "w_goa_nork_sel_comparison.png"),
