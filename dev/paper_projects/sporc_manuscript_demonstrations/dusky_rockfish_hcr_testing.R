...
saveRDS(sim_all, file = here("dev", "paper_projects", "sporc_manuscript_demonstrations", "dusky_rockfish_hcr_testing", "simulation_results.rds"))


# SECTION 9: VISUALIZATION =================================================

sim_all <- readRDS(file = here("dev", "paper_projects", "sporc_manuscript_demonstrations", "dusky_rockfish_hcr_testing", "simulation_results.rds"))
...
ggsave(
  here("dev", "paper_projects", "sporc_manuscript_demonstrations", "figs", "dusky_closedloop_presentation.png"),
  lineplot_pres,
  height = 10, width = 15
)
...
ggsave(
  here("dev", "paper_projects", "sporc_manuscript_demonstrations", "figs", "dusky_closedloop_hcr_presentation.png"),
  hcr_plot,
  height = 6, width = 6
)
