...
- [`dsem_series()`](https://chengmatt.github.io/SPoRC/dev/reference/dsem_series.md)
  : Helper that defines the names of the deviation series a dsem can
  link
...
- [`plot_dsem_dag()`](https://chengmatt.github.io/SPoRC/dev/reference/plot_dsem_dag.md)
