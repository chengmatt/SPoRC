...
build_at_age <- function(
  ...
  il <- suppressWarnings(Setup_Mod_Biologicals(
    il,
    WAA = array(1, dim = d1),
    WAA_fish = array(1, dim = c(d1, n_fleets)),
  ...
  il <- Setup_Mod_FishIdx_and_Comps(
    ...
    FishAgeComps_LikeType = rep("none", n_fleets),
    FishLenComps_LikeType = rep("none", n_fleets),
  ...
  il <- Setup_Mod_Fishsel_and_Q(
    il,
    cont_tv_fish_sel = paste0("none_Fleet_", fl),
    fish_sel_blocks = paste0("none_Fleet_", fl),
    fish_sel_model = paste0("logist1_Fleet_", fl),
    fish_q_blocks = paste0("none_Fleet_", fl),
    fish_fixed_sel_pars_spec = rep("est_all", n_fleets),
    fish_q_spec = rep("fix", n_fleets)
  )
