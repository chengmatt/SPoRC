...
| `stray_rate` | Array dimensioned by `n_pop`, `n_years` specifying the proportion of each population's spawning biomass that contributes to the effective SSB of non-natal regions. Used when `n_pop > 1` to allow stray contributions to recruitment at non-natal locations |
