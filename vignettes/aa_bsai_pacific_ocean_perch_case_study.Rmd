...
corrected limb of the ramp. That centres the recruitment penalty on
...
exponentiated with no normalisation:
...
the year range and the bin count that the smoothness penalties normalise by, and
