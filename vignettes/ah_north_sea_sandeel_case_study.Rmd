...
their annual rate is set so that the realized exposure matches.
...
find the same optimum. `smsR` penalizes its deviations towards the hockey stick
...
Also, the recruitment penalty is not the same statement. `smsR` penalizes its
