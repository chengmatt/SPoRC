...
| `trans_rho_catch` | `n_sexes × n_fish_fleets` | Unconstrained AR(1) correlation across ages for catch at age. Transformed to `(-1, 1)` by `rho_trans()`. One per fleet shared across sexes unless `rho_catch_key` says otherwise, and mapped to `NA` unless `AgeObsCorr_catch` is `"1dar1"` or `"2dar1"` | 0 |
