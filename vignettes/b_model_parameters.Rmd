...
| `stray_rate_pars` | `n_pop × n_stray_blocks` | Logit-scale stray rate parameters controlling the fraction of population p's spawning biomass that contributes to other populations' effective SSB at their natal regions. Only estimated when `use_fixed_stray_rate == 0`. Note: stray rate is likely unidentifiable from fishery and survey data alone and should be fixed or given an informative prior. | 0 |
