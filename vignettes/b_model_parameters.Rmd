...
| `trans_rho_catch` | `n_fish_fleets` | Unconstrained AR(1) correlation across ages for catch at age, one per fleet. Transformed to `(-1, 1)` by `rho_trans()`. Mapped to `NA` unless `AgeObsCorr_catch = "1dar1"` | 0 |
