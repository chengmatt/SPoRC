...
$$Z_{p,r,a,s}^{'} = \text{Natmort}_{p,r,y = 1,a,s} + \sum_{f=1}^{n_f} \text{Fmort}^{\text{InitProp}} \cdot \exp\left(\mu_{r,\tau,f}^{\text{Fsh}}\right) \cdot \mathbb{1}_{r,\tau,f}^{\text{Catch}} \cdot \text{Sel}_{p,r,y = 1,\tau,a,s,f}^{\text{Fsh}}$$
...
-   $\text{Fmort}^{\text{InitProp}}$ is a user-defined scalar describing
    the proportion of the mean fishing mortality applied uniformly across
    all fleets during the initialization stage,
-   $\mathbb{1}_{r,\tau,f}^{\text{Catch}}$ is an indicator variable equal
    to 1 if fleet $f$ is active in region $r$ and season $\tau$ in year 1,
    and 0 otherwise,
-   $\text{Sel}_{p,r,y = 1,\tau,a,s,f}^{\text{Fsh}}$ is the fishery
...
$$\begin{matrix}
Z_{p,r,y,\tau,a,s} = \text{Natmort}_{p,r,y,a,s} \cdot \Delta\tau + \sum_{f}^{}\text{Sel}_{p,r,y,\tau,a,s,f}^{\text{Fsh}}\text{Fmort}_{r,y,\tau,f} \\
\end{matrix}$$
...
$$\begin{matrix}
C_{p,r,y,\tau,a,s,f}^{a} = \dfrac{\text{Fmort}_{r,y,\tau,f}\text{Sel}_{p,r,y,\tau,a,s,f}^{\text{Fsh}}}{Z_{p,r,y,\tau,a,s}}N_{p,r,y,\tau,a,s}\left\lbrack 1 - \exp\left( - Z_{p,r,y,\tau,a,s} \right) \right\rbrack \\
\end{matrix}$$
...
$$\begin{matrix}
\text{FshIdx}_{p,r,y,\tau,f} = q_{r,y,f}^{\text{Fsh}}\sum_{a}^{a_{+}}{\sum_{s}^{n_{s}}N_{p,r,y,\tau,a,s}}\text{Sel}_{p,r,y,\tau,a,s,f}^{\text{Fsh}} \\
\end{matrix}$$
...
$$\begin{matrix}
\text{FshIdx}_{p,r,y,\tau,f} = q_{r,y,f}^{\text{Fsh}}\sum_{a}^{a_{+}}{\sum_{s}^{n_{s}}N_{p,r,y,\tau,a,s}}\text{Sel}_{p,r,y,\tau,a,s,f}^{\text{Fsh}}W_{p,r,y,\tau,a,s,f}^{fish} \\
\end{matrix}$$
...
$$Z_{p,r,y,\tau,a,s}^{\text{Tag}} = \kappa \cdot \Delta\tau + \text{NatMort}_{p,r,y,a,s} \cdot \Delta\tau + \sum_{f \in \mathcal{F}^{\text{Tag}}} \text{Sel}_{p,r,y,\tau,a,s,f}^{\text{Fsh}} \text{Fmort}_{r,y,\tau,f}$$
...
Similar to computations for catch-at-age, tag recaptures
are calculated using a modified version of Baranov's catch equation,
with fleet-specific tag reporting rates:

$$\text{Recap}_{p,r,y,\tau,a,s,f}^{k} = \beta_{r,y,f}\dfrac{\text{Fmort}_{r,y,\tau,f}\text{Sel}_{p,r,y,\tau,a,s,f}^{\text{Fsh}}}{Z_{p,r,y,\tau,a,s}^{\text{Tag}}}T_{p,r,y,\tau,a,s}^{k}\left\lbrack 1 - \exp\left( - Z_{p,r,y,\tau,a,s}^{\text{Tag}} \right) \right\rbrack$$
