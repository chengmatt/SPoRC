...
cohorts are released at the beginning of a season ($t^{\text{tag}} = 1$), Markovian
...
where $\beta_{r,y,f}$ represents a fleet-specific tag reporting rate parameter that can vary
