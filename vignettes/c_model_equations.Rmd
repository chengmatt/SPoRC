...
The observed fishery index is compared to the sum of predicted indices
across populations: $\sum_p \text{FshIdx}_{p,r,y,\tau,f}$.
...
The observed survey index is compared to the sum of predicted indices
across populations: $\sum_p \text{SrvIdx}_{p,r,y,\tau,sf}$.
