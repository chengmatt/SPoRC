...
selectivity, steepness, recruitment proportions, movement rates, and tag
reporting rates.
...
$${\begin{matrix}
a_{r,f}^{(\beta)} = \frac{\mu_{r,y,f}^{(\beta)}}{\left( \sigma_{r,y,f}^{(\beta)} \right)^{2}} \\
\end{matrix}
}{b_{r,f}^{(\beta)} = \left\lbrack \frac{1 - \mu_{r,y,f}^{(\beta)}}{\left( \sigma_{r,y,f}^{(\beta)} \right)^{2}} \right\rbrack
}{P\left( \beta_{r,y,f} \right) = \frac{\Gamma\left( a_{r,f}^{(\beta)} \right)\Gamma\left( b_{r,f}^{(\beta)} \right)}{\Gamma\left( a_{r,f}^{(\beta)} + b_{r,f}^{(\beta)} \right)}\beta_{r,y,f}^{a - 1}\left( 1 - \beta_{r,y,f} \right)^{b - 1}}$$

Here, $a_{r,f}^{(\beta)}$ and $b_{r,f}^{(\beta)}$ are the parameters describing
the beta distribution, $\mu_{r,y,f}^{(\beta)}$ denotes the prior mean for
tag reporting rates and $\sigma_{r,y,f}^{(\beta)}$ is the prior standard
deviation.
