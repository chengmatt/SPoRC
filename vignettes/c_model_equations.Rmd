...
$$Z_{p,r,a,s}^{'} = \text{Natmort}_{p,r,y = 1,a,s} + \mu_{r,\tau = 1,f = 1}^{\text{Fsh}}\text{Fmort}^{\text{InitProp}}\text{Sel}_{p,r,y = 1,\tau,a,s,f = 1}^{\text{Fsh}}$$
...
-   $\text{Sel}_{p,r,y = 1,\tau,a,s,f = 1}^{\text{Fsh}}$ is the fishery
