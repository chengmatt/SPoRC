...
The model carries four survey fleets: the bottom trawl survey, the acoustic trawl survey, the acoustic vessel of opportunity index, and the acoustic survey's age 1 abundance. The last is not a fifth survey. The pollock assessment fits the acoustic survey's age 1 abundance as its own likelihood component with its own catchability, separate from the acoustic biomass index and from its age composition, and `SPoRC` attaches one index to one survey fleet. `srv_idx_ages` is what restricts that fleet to age 1.
