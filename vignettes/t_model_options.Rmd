...
SPoRC offers four methods for deriving equilibrium numbers-at-age. All methods project a constant recruitment ($R_0$) through seasonal mortality, fishing, and (optionally) movement until the age structure stabilises. After the equilibrium is computed, multiplicative log-scale initial deviations (`ln_InitDevs`) are applied to ages $2, \ldots, A$.
