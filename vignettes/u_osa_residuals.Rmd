...
Catch at age, discards at age, and the survey index at age all
...
Valid at-age sources are `"CatchAA"`, `"DiscardAA"` and `"SrvIdxAA"`, each with a `pop = TRUE` variant. The returned data frame has
