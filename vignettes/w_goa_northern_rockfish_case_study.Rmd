...
The object has three kinds of content: the model inputs (`ObsCatch`, `WAA`,
...
ADMB template does. Every year has a deviation, including the terminal
...
The reconstructed catches before 1978 have a weight of $5$ and the observer era
series a weight of $50$, which is the assessment's way of saying the early
series is less certain. The F deviations have $\sigma_{F} = 1/\sqrt{2}$ with
...
$0.1$. Every composition source holds the assessment's own multipliers, which
...
Selectivity is time invariant in both fleets, so a single curve per gear has
everything.
